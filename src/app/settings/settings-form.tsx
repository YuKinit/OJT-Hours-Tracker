...
export default function SettingsForm(props: { userId: string; initial: OjtProfileRow }) {
  ...
  const [totalRequiredHours, setTotalRequiredHours] = React.useState<number>(props.initial.total_required_hours);
  const [hoursPerDay, setHoursPerDay] = React.useState<number>(props.initial.hours_per_day);
